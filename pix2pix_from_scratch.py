...
def experiment_fn(run_config, params):
    ...
    estimator = model.get_estimator(run_config, params)
    ...
    with tf.Graph().as_default():
        ...
        train_op, inference_model, loss = model.get_inference(ds.input_image,
                                                              ds.target_image,
                                                              training_flag)
...
if __name__ == '__main__':
    ...
    #
    # estimator = model.get_estimator(run_config, params)
    # estimator.train(input_fn=ds.train_input_fn, steps=5000)
